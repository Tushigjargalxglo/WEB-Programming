...
//     var proc = new Cs142TemplateProcessor(tbody.innerHTML);
...
//                 var tp1 = new Cs142TemplateProcessor(currCell.innerHTML);
//                 currCell.innerHTML = tp1.fillIn(dict);
//             }
//         } else {
//             if(r === 0) {
//                 for(var c1 = 0; c1 < colLen; c1++) {
//                     var cell = currRow.cells[c1];
//                     var tp2 = new Cs142TemplateProcessor(cell.innerHTML);
//                     cell.innerHTML = tp2.fillIn(dict);
//                     if(cell.innerHTML === columnName) { ind = c1; }
//                 }                
//             } else {
//                     var thisCell = currRow.cells[ind];
//                     var tp3 = new Cs142TemplateProcessor(thisCell.innerHTML);
//                     thisCell.innerHTML = tp3.fillIn(dict);
//             }
//         }
//     }
